  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 pt-20">
        {/* Carousel Container */}
        <div
          className="relative w-full max-w-5xl h-72 sm:h-80 md:h-96 mb-8 sm:mb-10"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center" style={{ perspective: "1000px" }}>
            {images.map((image, index) => {
              ...
              const y = Math.sin(angle) * radius * 0.35 // Flatten the ellipse for a horizontal orbit
              ...
              // Scale based on depth (z position) for parallax
              const depth = Math.sin(angle)
              const scale = 0.7 + (depth + 1) * 0.2 // 0.7 to 1.1
              ...
              return (
                <div
                  key={image.id}
                  className="absolute w-28 h-36 sm:w-36 sm:h-44 md:w-44 md:h-52 transition-all duration-300"
                  style={{
                    transform: `
                      translate(${x}px, ${y}px)
        ...
        {/* Content Section */}
        <div className="relative z-20 text-center max-w-2xl mx-auto mb-10 sm:mb-12">
